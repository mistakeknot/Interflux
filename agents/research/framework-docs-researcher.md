...
3. **Tool Selection for External Research**:
   ...
   - **Exa Deep** (`exa_search` with `type: neural`) — thorough research with AI-powered relevance. Best for nuanced queries, architectural patterns, and comprehensive documentation surveys.

   **Default strategy**: Start with Context7 for official docs, use Exa Fast for code examples, fall back to WebSearch for general research. Use Exa Deep when initial results are insufficient. If Exa is unavailable, Context7 + WebSearch cover most needs.
