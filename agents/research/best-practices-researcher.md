...
### Phase 1.75: Tool Selection for External Research

Choose the right tool for the job:

- **Context7 MCP** — official library/framework documentation. Best for API references, version-specific docs, and canonical examples.
- **WebSearch** — general web search for articles, blog posts, community discussions, and recent news.
- **Exa Fast** (`exa_search` with `type: auto`) — semantic code search. Best for finding real-world code examples, implementation patterns, and usage across open-source projects.
- **Exa Deep** (`exa_search` with `type: neural`) — thorough research with AI-powered relevance. Best for nuanced queries, architectural patterns, and comprehensive best-practice surveys.

**Default strategy**: Start with Context7 for docs, use Exa Fast for code examples, fall back to WebSearch for general research. Use Exa Deep when initial results are insufficient. If Exa is unavailable, Context7 + WebSearch cover most needs.
